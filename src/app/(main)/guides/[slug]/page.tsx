...
export async function generateStaticParams() {
    const params = await guidesSource.generateParams();
    return params
...
export default async function GuidePage({
    ...
    const page = await guidesSource.getPage([resolvedParams.slug]);
    ...
    const neighbours = await findNeighbour(guidesSource.pageTree, page.url);
